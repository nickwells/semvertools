...
This provides tools for manipulating semantic version IDs\. You can increment
the various parts and set or clear the pre\-release and build IDs\.

Alternatively you can supply the &apos;release\-candidate&apos; or
&apos;release&apos; parameters to start or finish asequence of pre\-releases
